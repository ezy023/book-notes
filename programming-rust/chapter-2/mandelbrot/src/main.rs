...
/// interation it took for `c` to leave the circle of radius 2 centered on the
...
///
/// Specifically, `s` should have the form <left><sef><right>, where <sep> is
...
/// The `upper_left` and `lower_rigght` parameters are points on the complex
