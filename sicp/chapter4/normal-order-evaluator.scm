;; capture underlying Lisp 'apply' before we mask it with the definition below
...
(define (eval exp env)
  (cond ((self-evaluating? exp) exp)
        ...
        ;; change for lazy-evaluation occurs in the handling of procedure applications
        ((application? exp)
         (display "HERE ") (display exp) (newline)
...
(define (actual-value exp env)
  (display "actual-value  ") (display exp) (newline)
...
;; force and delay procedures for thunk
(define (force-it obj)
  (display "force") (newline)
  ;; (display "force: ") (display obj) (newline)
  (if (thunk? obj)
...
(define (add-procs-to-env procs)
  (if (null? procs)
      'done
      (begin
        (eval (car procs) the-global-environment)
        (add-procs-to-env (cdr procs)))))
